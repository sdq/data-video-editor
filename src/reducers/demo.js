...
const scene1 = new Scene("A man is sitting on the chair and thinking about something.", 60.0);
...
const scene2 = new Scene("A woman is sitting on the ground and thinking about something.", 60.0);
