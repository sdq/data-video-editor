...
export default class ResourcePane extends Component {
    constructor(props) {
        ...
        this.newTabIndex = 0;
         const panes = [
           { icon: "picture", text:"",content: 'New Image', key: 'UImageser' },
           { icon: "gift", text:"",content: 'New Gif', key: 'Gif' },
           { icon: "customer-service",text:"", content: 'New Audio', key: 'Audio' },
           { icon: "play-square", text:"",content: 'New Video', key: 'Video' },
         ];
        this.state = {
