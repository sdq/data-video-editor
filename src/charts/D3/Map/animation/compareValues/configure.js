...
export default class configure extends Component {
    ...
    render() {
        ...
        let selectedCategory2 = animation.spec.category1?animation.spec.category1:categories[1];
        ...
        return (
            <div>
                ...
                <Row  style={{ height: 50 }}>
                    ...
                    <Col span={9}>
                        <Select defaultValue={selectedCategory1} style={{ width: 120, marginTop: 4 }} onChange={this.handleCategory1Change}>
                ...
                <Row  style={{ height: 50 }}>
                    ...
                    <Col span={9}>
                        <Select defaultValue={selectedCategory2} style={{ width: 120, marginTop: 4 }} onChange={this.handleCategory2Change}>
                            {categories.map((s) => <Option key={s} value={s}>{s}</Option>)}
                        </Select>
                    </Col>
                    <Col span={9}>
